...
#' @export
#' @usage miR_mRNA_IntDF(miR_express, GenesofInterest, maxInt)
#' @examples
...
#'miR_mRNA_IntDF(miR_express = MIR, GenesofInterest = G,
#'maxInt = 5) -> correlation_matrix
miR_mRNA_IntDF <- function(miR_express, GenesofInterest, maxInt){
        ...
        interactions_df <- do.call(rbind, apply(allnames, 1, CorrTable,
        miR_express, GenesofInterest,
        maxInt = maxInt))
