...
#' @export
#' @usage miR_mRNA_IntDF(MAE, miR_express, GenesofInterest, maxInt)
#' @examples
...
#'MAE <- miR_mRNA_IntDF(MAE, miR_express = MIR, GenesofInterest = G, 
#'                      maxInt = 5) 
miR_mRNA_IntDF <- function(MAE, miR_express, GenesofInterest, maxInt){
