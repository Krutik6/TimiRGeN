#' @title quickNet
#' @description Generates an internal igraph network representing the miR-mRNA
...
#' as metadata in the MAE used in the makeNet function.
...
quickNet <- function(net){
    ...
    if(missing(net)) stop('Please use the makeNet function. The output should
                          be stored as metadata within the MAE used in the
                          makeNet function.')
