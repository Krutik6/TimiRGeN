...
readRDS(file = "SignificanVals_s/filtered_genelist_s") -> filtered_genelist
readRDS(file = "getIDs_miR_mouse/miR_ensembl.rds") -> miR_ensembl
readRDS(file = "getIDs_mRNA_mouse/mRNA_ensembl.rds") -> mRNA_ensembl
#test function
...
#save data
saveRDS(ensembl_genes, file = "AddIDs_s/ensembl_genes.rds", compress = "xz")
