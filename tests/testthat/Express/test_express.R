...
#continue
merge(exp, mRNA_entrez, by.x = 'names', by.y = 'GENENAME', all = TRUE) -> merged
...
#save data as rds
saveRDS(miR_log2fc, "Express/miR_log2fc.rds", compress = "xz")
saveRDS(mRNA_log2fc, "Express/mRNA_log2fc.rds", compress = "xz")
