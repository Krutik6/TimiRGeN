...
library(testthat)
#load data
readRDS("Express/miR_log2fc.rds") -> miR_log2fc
miR_log2fc[1:100,] -> miR_log2fc
readRDS("Express/mRNA_log2fc.rds") -> mRNA_log2fc
mRNA_log2fc[1:200,] -> mRNA_log2fc
readRDS("ReduceWiki/test_net.rds") -> wiki_interest
...
#save data
saveRDS(interactions_df, "interactions_df/interactions.rds",
compress = "xz")
