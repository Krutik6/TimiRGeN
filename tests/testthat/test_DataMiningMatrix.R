...
#load data
readRDS("TargetScans_results.rds") -> TargetScans_res
as.data.frame(TargetScans_res) -> TargetScans_res
readRDS("miRDB_resuts.rds") -> miRDB_res
as.data.frame(miRDB_res) -> miRDB_res
readRDS("miRTarBase_results.rds") -> miRTarBase_res
as.data.frame(miRTarBase_res) -> miRTarBase_res
readRDS("interactions.rds") -> Interactions
