...
#save output
saveRDS(miR_adjusted_ensembl, "hs_miR_adjusted_ensembl.rds", compress = "xz")
saveRDS(miR_adjusted_entrez, "hs_miR_adjusted_entrez.rds", compress = "xz")
saveRDS(miR_ensembl, "hs_miR_ensembl.rds", compress = "xz")
saveRDS(miR_entrez, "hs_miR_entrez.rds", compress = "xz")
