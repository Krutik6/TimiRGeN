...
```{r Datamining, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r addMiningmatrix, echo=FALSE}
Int_data -> Data@ExperimentList$mining_matrix 
```
...
NegativeOnly = TRUE, THRESHOLD = 2, PredictedOnly = FALSE,
maxCor = 0.2) -> Data@ExperimentList$filt_df
```
