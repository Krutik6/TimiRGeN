...
The `Express` function will retreive one specific of the differential
...
Note that if there are not enough pathway enrichments found the `"s"`
...
Next we retreive ensembl or entrezIDs for our human data. smiRk can only work
...
```{r rmplots, echo=FALSE, message=FALSE, warning=FALSE}
file.remove("mus.gmt")
